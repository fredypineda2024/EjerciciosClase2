...
// suele ser los miércoles y las entradas se reducen hasta en un 70%. La única pega es que suele ir mucha más gente...
...
public class Ejercicio4 {
    public static void main(String[] args) {
        // Dinero con el que Carmen sale de casa
        double dineroInicial = 23.0;
        
        // Dinero que le queda al regresar
        ...
        System.out.println(" Dinero que le queda al regresar " +dineroFinal);
    }
}